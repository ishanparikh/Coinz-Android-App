...
public class MainActivityTest_SignInRegisteredUser {

    @Rule
    public ActivityTestRule<MainActivity> mActivityTestRule = new ActivityTestRule<>(MainActivity.class);

    @Test
    public void mainActivityTest_SignInRegisteredUser() {
        ...
        ViewInteraction appCompatEditText2 = onView(
                allOf(withId(R.id.editTextEmail), withText("m"),
                        childAtPosition(
                                allOf(withId(R.id.linearLayout),
                                        childAtPosition(
                                                withClassName(is("android.support.constraint.ConstraintLayout")),
        ...
        ViewInteraction appCompatEditText3 = onView(
                allOf(withId(R.id.editTextEmail), withText("m"),
                        childAtPosition(
                                ...
                                1),
                        isDisplayed()));
        appCompatEditText3.perform(replaceText("man"));

        ViewInteraction appCompatEditText4 = onView(
                allOf(withId(R.id.editTextEmail), withText("man"),
                        childAtPosition(
                                allOf(withId(R.id.linearLayout),
                                        childAtPosition(
                                                withClassName(is("android.support.constraint.ConstraintLayout")),
        ...
        ViewInteraction appCompatButton = onView(
                allOf(withId(R.id.buttonRegister), withText("Signup"),
                        childAtPosition(
                                childAtPosition(
